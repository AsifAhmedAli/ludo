...
public class ControlAvatars : MonoBehaviour
{
    ...
    public void reset()
    {
        ...
        if (GameManager.Instance.type == MyGameType.Private && !GameManager.Instance.JoinedByID)
        {
            ...
            RoomIDText.GetComponent<TMP_Text>().text = "Fetching...";
        }
        else
        {
            RoomIDObject.SetActive(false);
    ...
    public void ShareCode()
    {
        ...
        string shareText = StaticStrings.SharePrivateLinkMessage + " " + RoomIDText.GetComponent<TMP_Text>().text + "\n\n" + StaticStrings.SharePrivateLinkMessage2 + " ";
#if UNITY_ANDROID
    ...
    public void updateRoomID(string id)
    {
        ...
        RoomIDText.GetComponent<TMP_Text>().text = id;
    }
    ...
    public IEnumerator updateMessageBubbleText()
    {
        ...
        if (!GameManager.Instance.opponentDisconnected)
            messageBubbleText.GetComponent<TMP_Text>().text = StaticStrings.waitingForOpponent + " " + waitingOpponentTime;
