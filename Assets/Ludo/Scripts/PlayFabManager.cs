...
public class PlayFabManager : Photon.PunBehaviour, IChatClientListener
{
    ...
    public void addGemsRequest(int count)
    {
        Dictionary<string, string> data = new Dictionary<string, string>();
        data.Add(MyPlayerData.GemsKey, "" + (GameManager.Instance.myPlayerData.GetGems() + count));
        GameManager.Instance.myPlayerData.UpdateUserData(data);
        Debug.Log(GameManager.Instance.myPlayerData.GetGems());
    }
    ...
    public void Login()
    {
        ...
        PlayFabClientAPI.LoginWithCustomID(request, (result) =>
        {
            ...
            UpdateUserTitleDisplayNameRequest displayNameRequest = new UpdateUserTitleDisplayNameRequest()
            {
                ...
                DisplayName = GameManager.Instance.playfabManager.UserName
            };
