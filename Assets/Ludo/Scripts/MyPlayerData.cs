...
public class MyPlayerData
{
    ...
    public static string GemsKey = "Gems";
    ...
    public int GetGems()
    {
        if (this.data != null && this.data.ContainsKey(GemsKey))
            return int.Parse(this.data[GemsKey].Value);
        else return 0;
    }
    ...
    public string GetAvatarIndex()
    {
        ...
        else
        {
            ...
            return "0"; // Replace "default_value" with your desired default value.
        }
    }
