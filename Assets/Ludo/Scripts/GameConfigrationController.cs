...
public class GameConfigrationController : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        switch (GameManager.Instance.type)
        {
            case MyGameType.TwoPlayer:
                TitleText.GetComponent<TMP_Text>().text = "Two Players";
                break;
            case MyGameType.FourPlayer:
                TitleText.GetComponent<TMP_Text>().text = "Four Players";
                break;
            case MyGameType.Private:
                TitleText.GetComponent<TMP_Text>().text = "Private Room";
    ...
    {
        bidText.GetComponent<TMP_Text>().text = StaticStrings.bidValuesStrings[currentBidIndex];
